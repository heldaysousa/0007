/*
  # Business Settings and Configuration Tables

  1. New Tables
    - business_settings: Store general business settings
    - payment_schedules: Configure commission payment schedules
    - inventory_categories: Categories for inventory items
    - inventory_items: Track inventory and supplies
    
  2. Changes
    - Add settings-related tables and relationships
