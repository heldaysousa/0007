...
INSERT INTO professionals (id, owner_id, name, phone, document_number, base_commission_rate, active)
SELECT 
  gen_random_uuid(),
  auth.uid(),
  name,
...
FROM (
  VALUES 
    ('Andréia Silva', '(11) 98765-4321', '123.456.789-00', 40.00),
    ('Mariana Santos', '(11) 98765-4322', '234.567.890-11', 35.00),
    ('Carolina Oliveira', '(11) 98765-4323', '345.678.901-22', 45.00),
    ('Beatriz Costa', '(11) 98765-4324', '456.789.012-33', 38.00)
) AS t(name, phone, document_number, base_commission_rate)
