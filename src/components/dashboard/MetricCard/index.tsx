import React from 'react';
    ...
    export function MetricCard({ title, value, icon: Icon, progress, subtitle }: MetricCardProps) {
      return (
        <motion.div
          whileHover={{ scale: 1.02 }}
          transition={{ type: "spring", stiffness: 300 }}
          className="bg-[#1C1C1C] rounded-lg p-5 shadow-[0px_4px_8px_rgba(0,0,0,0.2)] border-l-4 border-[#4B0082] hover:scale-102"
        >
