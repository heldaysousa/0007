    ...
    export default function Login() {
      ...
      return (
        <motion.div 
          ...
          className="min-h-screen bg-gradient-to-br from-accent-purple via-purple-700 to-purple-900 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex"
        >
          <button
            onClick={toggleTheme}
            ...
            <div className="max-w-md w-full space-y-8">
              <div className="text-center">
                <div className="flex justify-center mb-8">
                  <Logo size="lg" className="w-48 text-white" style={{ filter: 'var(--logo-filter)' }} />
                </div>
